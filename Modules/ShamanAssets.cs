...
{
    internal static class ShamanAssets
    {
        #region shaman's stuff
        // particle effects
        ...
        //internal static NetworkSoundEventDef healOrbSoundEvent;
        internal static NetworkSoundEventDef acolyteSwingImpactSoundEvent;
        //internal static NetworkSoundEventDef healOrbImpactSoundEvent;
        ...
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream($"{csProjName}.ShamanBank.bnk"))
            {
        ...
        internal static void PopulateAssets()
        {
            ...
            //healOrbImpactSoundEvent = CreateNetworkSoundEventDef("ShamanHealOrbExplode");
            ...
            //acolyteBeastSlamEffect = RoR2.LegacyResourcesAPI.Load<GameObject>("Prefabs/Effects/BeetleGuardGroundSlam");

            /*if (greandeExplosionEffect)
            {
                ShakeEmitter shakeEmitter = greandeExplosionEffect.AddComponent<ShakeEmitter>();
