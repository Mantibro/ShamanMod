...
namespace ShamanMod.Modules
{
    ...
    internal static class Skills
    {
        ...
        public static void CreateSkillFamiliesAlternate(GameObject targetPrefab, int families = 15, bool destroyExisting = true)
        {
        ...
        public static GenericSkill CreateGenericSkillWithSkillFamily(GameObject targetPrefab, string familyName, bool hidden = false)
        {
            ...
            ShamanMod.Modules.Content.AddSkillFamily(newFamily);
            return skill;
        }
        #endregion
        ...
        public static T CreateSkillDef<T>(SkillDefInfo skillDefInfo) where T : SkillDef
        {
            ...
            ShamanMod.Modules.Content.AddSkillDef(skillDef);
