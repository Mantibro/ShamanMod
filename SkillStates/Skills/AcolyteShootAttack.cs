...
namespace ShamanMod.SkillStates
{
    ...
    {
        public static float damageCoefficient = Modules.StaticValues.acShootDamageCoefficient;
        ...
        {
            base.OnEnter();
            this.duration = AcolyteShootAttack.baseDuration / this.attackSpeedStat;
            ...
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    ...
                    new BulletAttack
                    {
                        ...
                        damage = AcolyteShootAttack.damageCoefficient * this.damageStat,
                        damageColorIndex = DamageColorIndex.Default,
                        damageType = DamageType.Generic,
                        falloffModel = BulletAttack.FalloffModel.DefaultBullet,
                        maxDistance = AcolyteShootAttack.range,
                        force = AcolyteShootAttack.force,
                        ...
                        weapon = null,
                        tracerEffectPrefab = AcolyteShootAttack.tracerEffectPrefab,
                        spreadPitchScale = 0f,
                        spreadYawScale = 0f,
